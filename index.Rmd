---
title: "Workshop <br>⚔<br/>Introduction to PsychoPy & Pavlovia"
subtitle: "3rd International Connect Malaysia Conference 2021"
...
meta() %>%
  meta_general(
    description = "A gentle introduction to PsychoPy & Pavlovia",
    generator = "xaringan and remark.js"
  ) %>% 
  meta_name("github-repo" = "sohmeiling/Workshop_M_Connect") %>% 
  meta_social(
    title = "Workshop: An Introduction to PsychoPy & Pavlovia",
    url = "https://sohmeiling.github.io/Workshop_M_Connect/",
    image = "https://sohmeiling.github.io/Workshop_M_Connect/cover.png",
    image_alt = "The first slide of the Workshop: An Introduction to PsychoPy & Pavlovia presentation",
    og_type = "website",
    og_author = "Soh Mei Ling",
    twitter_card_type = "summary_large_image",
    twitter_creator = "@sohmeiling"
  )
```
...
- We have set up a [Slack Workspace](https://join.slack.com/t/mconnect2021/shared_invite/zt-uc73uvir-S03xdQsLdTUNwLXqUBTJiw) for any technical difficulties during the session. Please ask your question by posting a new message in the .pink[\#Troubleshooting channel]. 
...
<br>
```{r  out.width = "50%", fig.cap= "Arghhhh!!!! What happened?", fig.align="center", dpi =96, echo=FALSE}
...
```{r  out.width = "30%", fig.cap= "Hmmmm.....", fig.align="center", dpi =96, echo=FALSE}
...
#### <br>As you know, we are all in the Slack group. Please direct your questions there 😊] 
