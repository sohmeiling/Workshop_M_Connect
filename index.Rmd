...
.footnote.gray[
For those unfamiliar with Slack, you can just click on the Slack link and join the channels. You will need to login with an email address. 
]
---
...
---
layout:false
background-image: url(image/transition.jpg)
background-position: 50% 50%
background-size: cover
class: inverse, center, bottom

# .font_medium[.black[Getting Started <br/><br/>(Basics)]]

<br><br><br><br><br>

.right[.black[Photo by <a href="https://unsplash.com/@scottwebb?utm_source=unsplash&utm_medium=referral&utm_content=creditCopyText">Scott Webb</a> on <a href="https://unsplash.com/s/photos/clean?utm_source=unsplash&utm_medium=referral&utm_content=creditCopyText">Unsplash</a>
  ]]
---
## Builder View
...
⚠️ If you want to collect responses from a participant, you need to select all the three functions above, or else your experiment will just run.

.gray[More information is available at the [PsychoPy webpage](https://www.psychopy.org/builder/components/keyboard.html)]
...
```{r  out.width = "65%", fig.align="center", fig.cap= "GIF for adding new loop", dpi =96, echo=FALSE}
include_graphics("gif/add-new-loop.gif") 
```

---
background-image: url(image/leaf-jazmin.jpg)
background-position: 50% 50%
background-size: cover
...
# .black[Getting Started <br/><br/>(Designing Stoop Task)]
...
---
background-image: url(image/pause.jpg)
background-position: 50% 50%
background-size: cover
class: inverse, center, middle
layout: false

# .black[Let's pause for a moment]
