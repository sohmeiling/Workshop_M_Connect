...
# .center[Workshop <br>⚔<br/>Introduction to <br>PsychoPy & Pavlovia]

## .center[<br> Kai Hao | Mei Ling | Jonathan Choo ]
...
- This is a huge workshop, so please do understand if we can't get to your question immediately. However, please be ensure that we will definitely answer your question, or at least direct you to someone who knows the answer. 
...
- You can find [all material here <i class="fab fa-github"></i> ](https://github.com/sohmeiling/Workshop_M_Connect) or [download as zip here <i class="fa fa-download"></i> ](https://github.com/sohmeiling/Workshop_M_Connect/archive/refs/heads/main.zip)
...
---
layout:false
background-image: url(image/gettingStart1.png)
background-position: 50% 50%
background-size: cover
class: inverse, center, middle


.footnote[.black[Photo by [Scott Webb](https://unsplash.com/@scottwebb?utm_source=unsplash&utm_medium=referral&utm_content=creditCopyText) on [Unsplash](https://unsplash.com/)]
  ]
---
## Builder View
...
---
layout:false
background-image: url(image/anyQ.png)
background-position: 50% 50%
background-size: cover
class: inverse, center, middle


.footnote[.black[Photo by [Sarah Dorweiler
](https://unsplash.com/@sarahdorweiler) on [Unsplash](https://unsplash.com/)]
  ]
...
.footnote[
Photo by <a href="https://unsplash.com/@agatacreate?utm_source=unsplash&utm_medium=referral&utm_content=creditCopyText">Agata Create</a> on <a href="https://unsplash.com/@jazminantoinette?utm_source=unsplash&utm_medium=referral&utm_content=creditCopyText">Unsplash</a>
]
...
Almost identital the same as the Text and Image properties.
...
.footnote[
Photo by <a href="https://unsplash.com/@sarahdorweiler?utm_source=unsplash&utm_medium=referral&utm_content=creditCopyText">Sarah Dorweiler</a> on <a href="https://unsplash.com/@sarahdorweiler?utm_source=unsplash&utm_medium=referral&utm_content=creditCopyText">Unsplash</a>
...
---
background-image: url(image/gettingStart2.png)
background-position: 50% 50%
background-size: cover
class: inverse, center, middle


.footnote[.black[Photo by <a href="https://unsplash.com/@jazminantoinette?utm_source=unsplash&utm_medium=referral&utm_content=creditCopyText">Jazmin Quaynor</a> on <a href="https://unsplash.com/collections/2183251/minimalisty?utm_source=unsplash&utm_medium=referral&utm_content=creditCopyText">Unsplash</a>
  ]]
...
Workshop_M_Connect-Main  ➡️ Workshop_M_Connect-Main  ➡️ practical_Build_Stroop  ➡️ stroop-test.psyexp
...
---
background-image: url(image/pause1.png)
background-position: 50% 50%
background-size: cover
class: inverse, center, middle
layout: false
...
.footnote[.grey[Photo by <a href="https://unsplash.com/@scottwebb?utm_source=unsplash&utm_medium=referral&utm_content=creditCopyText">Scott Webb</a> on <a href="https://unsplash.com/s/photos/clean?utm_source=unsplash&utm_medium=referral&utm_content=creditCopyText">Unsplash</a>
  ]]
...
# Desktop\Workshop_M_Connect-main\Workshop_M_Connect-main\Practical_Build_stroop\wordPractice_stim.xlsx
...
---
background-image: url(image/pause2.png)
background-position: 50% 50%
background-size: cover
class: inverse, center, middle
layout: false
...
.footnote[.black[Photo by <a href="https://unsplash.com/@agatacreate?utm_source=unsplash&utm_medium=referral&utm_content=creditCopyText">Agata Create</a> on <a href="https://unsplash.com/@sarahdorweiler?utm_source=unsplash&utm_medium=referral&utm_content=creditCopyText">Unsplash</a>
]]
...
```
 ...
 💭 Make changes in the .bg-main4[**trial_text**] and .bg-main4[**trial_resp**] components. 
...
<source src="image/trial-routine.mp4" type="video/mp4">
</video>
...
.gray[Under **Begin Routine** tab, you now define what the msg object contains using a simple if-else statement
...
If participants did note press any of the response keys, the msg object will now contain .red[“Failed to respond”]
...
We do not have time for Navon Task but we have programmed a sample task for your reference. 

For those adventurous ones, you can refer to the manual for Navon Task. 

---

## Final final thing to do

Insert the logo here later. 
